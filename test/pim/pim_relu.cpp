...
TEST(HIPIntegrationTest, PimRelu1Sync) {
  EXPECT_TRUE(pim_relu_up_to_256KB(true, 128 * 1024) == 0);
}
TEST(HIPIntegrationTest, PimRelu1Async) {
  EXPECT_TRUE(pim_relu_up_to_256KB(false, 128 * 1024) == 0);
}
TEST(HIPIntegrationTest, PimRelu2Sync) {
  EXPECT_TRUE(pim_relu_up_to_256KB(true, 1 * 1024) == 0);
}
TEST(HIPIntegrationTest, PimRelu2Async) {
  EXPECT_TRUE(pim_relu_up_to_256KB(false, 1 * 1024) == 0);
}
